    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-20 hidden lg:block">
        <motion.div 
          ...
          className="glow-card p-4 space-y-2"
        >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div className="px-4 py-2 rounded-full border border-primary/30 bg-card/60 backdrop-blur-sm">
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="px-8 py-4 text-lg font-semibold border-primary/50 hover:border-primary glow-card"
          ...
          >
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="p-3 rounded-full glow-card group relative overflow-hidden"
      ...
      >
        ...
        >
          <Button
            ...
            className="p-2 rounded-full glow-card hover:bg-primary/10 transition-colors duration-300"
          >
